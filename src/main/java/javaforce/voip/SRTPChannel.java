...
public class SRTPChannel extends javaforce.voip.RTPChannel {
  protected SRTPChannel(javaforce.voip.RTP rtp, int ssrc, SDP.Stream stream) {
    ...
    new Thread() {
      public void run() {
        ...
        try {
          ...
          dtlsSocket = new DatagramSocket(javaforce.voip.RTP.getnextlocalrtpport());
