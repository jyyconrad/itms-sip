...
*/
  ...
  public void buildsdp(CallDetails cd, CallDetails.SideDetails cdsd) {
    ...
    for(int a=0;a<sdp.streams.length;a++) {
      ...
      Codec rfc2833 = getCodec(stream.codecs, javaforce.voip.RTP.CODEC_RFC2833);
      ...
      if (stream.type == SDP.Type.audio && rfc2833 == null) {
        rfc2833 = javaforce.voip.RTP.CODEC_RFC2833;
      ...
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_G711u)) {
        content.append("a=rtpmap:0 PCMU/8000\r\n");
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_G711a)) {
        content.append("a=rtpmap:8 PCMA/8000\r\n");
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_GSM)) {
        content.append("a=rtpmap:3 GSM/8000\r\n");
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_G722)) {
        content.append("a=rtpmap:9 G722/8000\r\n");  //NOTE:It's really 16000 but an error in RFC claims it as 8000
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_G729a)) {
      ...
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_JPEG)) {
        content.append("a=rtpmap:26 JPEG/90000\r\n");
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_H263)) {
        content.append("a=rtpmap:34 H263/90000\r\n");
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_H263_1998)) {
        content.append("a=rtpmap:" + getCodec(stream.codecs, javaforce.voip.RTP.CODEC_H263_1998).id + " H263-1998/90000\r\n");
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_H263_2000)) {
        content.append("a=rtpmap:" + getCodec(stream.codecs, javaforce.voip.RTP.CODEC_H263_2000).id + " H263-2000/90000\r\n");
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_H264)) {
        content.append("a=rtpmap:" + getCodec(stream.codecs, javaforce.voip.RTP.CODEC_H264).id + " H264/90000\r\n");
      }
      if (hasCodec(stream.codecs, javaforce.voip.RTP.CODEC_VP8)) {
        content.append("a=rtpmap:" + getCodec(stream.codecs, javaforce.voip.RTP.CODEC_VP8).id + " VP8/90000\r\n");
      }
